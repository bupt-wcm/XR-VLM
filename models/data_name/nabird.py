...
temp = [
    # 'a bird photo of the {cls_name}',             # zero-shot: 224x224 50.00%,
    # 'a bird image of the {cls_name}',             # zero-shot: 224x224 48.44%,
    # 'a photo of the {cls_name}, a type of bird.', # zero-shot: 224x224 39.06%,
    'a photo of the {cls_name}',                    # zero-shot: 224x224 43.75%,
]
