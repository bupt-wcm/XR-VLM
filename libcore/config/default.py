...
_DATA_CFG_DICT.NABIRD = CN()
_DATA_CFG_DICT.NABIRD.DATA = CN()
_DATA_CFG_DICT.NABIRD.DATA.NAME = "NABIRD"
_DATA_CFG_DICT.NABIRD.DATA.INPUT = CN()
_DATA_CFG_DICT.NABIRD.DATA.INPUT.SIZE_SCALE = 600,
_DATA_CFG_DICT.NABIRD.DATA.PATH = "data/fine-grained-data/nabirds"
